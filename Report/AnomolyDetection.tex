...
\begin{abstract}
   ...
   The first method examined is C-LSTM neural network applied directly to timeseries web traffic data, as described in the paper by Tae-Young Kim and Sung-Bae Cho \cite{kim2018web}.  
...
\hline
\textbf{Name}                & \textbf{Primary Responsibilities}                   & \textbf{Secondary Responsibilities} \\ \hline
Lily Chebotarova             & Researched labelled anomaly detection datasets and found selected yahoo dataset for project. Developed C-LSTM model implementation code. & Data pre-processing                  \\ \hline
Raga Lasya Munagala          & Developed data pre-processing code.                 &                                      \\ \hline
Ligeng Peng                  & Developed autoencoder with regression model implementation code. &                                      \\ \hline
Brian Zhang                  & Primary author for text of report itself, handled all LaTeX formatting. Created and maintained team git repo: \url{https://github.com/brian-x-zhang/CS7643-Anamoly}. Performed hyperparameter tuning of C-LSTM \& Auto-encoder models. &                                      \\ \hline
\end{tabular}
